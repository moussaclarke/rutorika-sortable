...
class SortableController extends Controller
{
    ...
    protected function getValidator($sortableEntities, $request)
    {
        ...
        if (!$relation) {
            ...
            $rules['id'] .= '|exists:' . $pivotTable . ',' . $relationObject->getOwnerKey() . ',' . $relationObject->getForeignKey() . ',' . $request->input('parentId');
            $rules['positionEntityId'] .= '|exists:' . $pivotTable . ',' . $relationObject->getOwnerKey() . ',' . $relationObject->getForeignKey() . ',' . $request->input('parentId');
        }
